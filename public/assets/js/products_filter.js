// Sistema de Filtro e Busca para Produtos ProducPlus
...
function gerenciarMensagemSemResultados(quantidade) {
    ...
    if (quantidade === 0) {
        if (!mensagem) {
            ...
            // Adiciona a mensagem no primeiro container-products
            const primeiroContainer = document.querySelector('.container-products');
            if (primeiroContainer) {
                primeiroContainer.appendChild(mensagem);
            }
        }
