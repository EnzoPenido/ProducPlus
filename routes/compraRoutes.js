...
router.get("/meus-pedidos", autenticarJWT, permitirRoles("CLIENTE", "ADMIN"), listarMinhasCompras);
router.post("/", autenticarJWT, permitirRoles("CLIENTE", "ADMIN"), finalizarCompraCompleta);
